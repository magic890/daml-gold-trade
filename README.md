...
The custody chain and pledges history in the `Asset` enable all the participants to see the changes and interest rates applied. The transparency achieved increases confidence and incentivize all parties to act with integrity and honesty.
